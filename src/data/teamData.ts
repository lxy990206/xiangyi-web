 ...
 * 自动同步生成时间: 2026-08-26T18:28:00.957Z (2026/8/27 02:28:00)
...
export const TEAM_INFO = {
  ...
  "milestones": [
    ...
    },
    {
      ...
      "year": "2025.10.03",
      "title": "首支原创单曲《依你共鸣》",
      "desc": "相依社成立首支原创纪念曲于Bilibili正式上线，收获广大中文V家听众的好评。"
    },
    {
      "id": "m-3",
      "year": "2025.12.30",
      "title": "企划专辑《相依之音》立项",
      "desc": "开启跨社团联合共创，收录多首洛天依、乐正绫原创曲目。"
    },
    {
      "id": "m-4",
      "year": "2026.02.17",
